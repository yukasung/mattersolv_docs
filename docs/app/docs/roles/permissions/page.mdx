...
| --- | --- | --- | --- |
| สำนักงานและสมาชิก | การตั้งค่าสำนักงาน | `tenant.tenant` | — |
| สำนักงานและสมาชิก | สมาชิก | `tenant.tenant_user` | `tenant.invite_tenant_user` |
| สำนักงานและสมาชิก | บทบาท | `auth.group` | — |
| ข้อมูลตั้งต้น | ข้อมูลตั้งต้น | `tenant.master_data` | — |
...
| บันทึกตรวจสอบและความปลอดภัย | ความปลอดภัย | `tenant.security_setting` เฉพาะ `view/change` | — |
